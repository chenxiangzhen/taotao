...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		//URL_Serv: "http://localhost:8092/category.json?callback=category.getDataService",
		URL_Serv: "http://localhost:8092/rest/item/cat/list?callback=category.getDataService",
